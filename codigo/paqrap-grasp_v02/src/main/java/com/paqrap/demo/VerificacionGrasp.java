...
public final class VerificacionGrasp {
    ...
    public static void main(String[] args) {
        ...
        pruebaPlazo();
        pruebaBusquedaLocal();
        System.out.println("OK - 5 verificaciones de GRASP superadas, incluida la busqueda local.");
    }
    ...
    private static void pruebaBusquedaLocal() {
        LocalDateTime ahora = LocalDateTime.of(2026, 9, 8, 8, 0);
        ...
        Almacen central = Almacen.central("ALM-C", a);
        Vehiculo auto = new Vehiculo(
                "AUTO", TipoVehiculo.AUTO, EstadoVehiculo.DISPONIBLE, a);
        ...
        exigir(s.getRutas().size() == 1, "La prueba local debe producir una sola ruta.");
        Ruta ruta = s.getRutas().get(0);
        exigir(ruta.getPedidos().equals(List.of(p3, p1, p2)),
                "La búsqueda local debe reordenar la ruta a P3 -> P1 -> P2.");
        exigir(Math.abs(ruta.getDistanciaTotalKm() - 59.0) < 1e-9,
                "La búsqueda local debe reducir la ruta de 110 km a 59 km.");
    }
